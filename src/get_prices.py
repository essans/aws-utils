...
def ondemand1(
    ...
    license_model: str = "No License required",) -> Optional[float]:
    
    # Query pricing api
    # Pass region_name="us-east-1" to pricing Api.
    # Build filters to target a standard Linux shared-tenancy SKU.
    try:
...
def ondemand2(
    ...
    try:
        ...
        # Swallow and return None per your original behavior
        return None
